...
Further, writing the correlation column to the final data.
...
For plotting correlation chart using google trend series - 
...
barplot(mses, beside=TRUE, xaxt = "n",xlab='', main="Mse for each index with SMA and RW Predcitions", ylab= 'MSE')
